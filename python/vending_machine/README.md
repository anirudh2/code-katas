...
+ The vending machine will accept valid coins (nickels, dimes, and 
quarters) and reject invalid ones (pennies).  

- When a valid coin 
is inserted the amount of the coin will be added to the current 
amount and the display will be updated.
